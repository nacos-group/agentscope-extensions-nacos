 ...
 * @author xiweng.yy
 */
public class ToolUseBlockParser implements ContentBlockParser<ToolUseBlock> {
    
    @Override
    public Part<?> parse(ToolUseBlock contentBlock) {
        Map<String, Object> metadata = MessageConvertUtil.buildTypeMetadata(MessageConstants.BlockContent.TYPE_TOOL_USE);
