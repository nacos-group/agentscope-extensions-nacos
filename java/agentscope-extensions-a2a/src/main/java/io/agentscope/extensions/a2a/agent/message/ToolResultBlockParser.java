...
public class ToolResultBlockParser implements ContentBlockParser<ToolResultBlock> {
    ...
    public Part<?> parse(ToolResultBlock contentBlock) {
        Map<String, Object> metadata = MessageConvertUtil.buildTypeMetadata(MessageConstants.BlockContent.TYPE_TOOL_RESULT);
        ...
        Map<String, Object> output = Map.of(MessageConstants.TOOL_RESULT_OUTPUT_METADATA_KEY, contentBlock.getOutput());
