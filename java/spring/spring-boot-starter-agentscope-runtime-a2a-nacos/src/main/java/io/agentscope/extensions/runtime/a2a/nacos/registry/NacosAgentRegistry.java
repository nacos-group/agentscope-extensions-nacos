...
public class NacosAgentRegistry implements AgentRegistry {
    ...
    private AgentCard doOverwrite(AgentCard agentCard, NacosA2aRegistryTransportProperties transportProperties) {
    ...
    private String generateNewUrl(NacosA2aRegistryTransportProperties transportProperties) {
        ...
        String url = String.format(AGENT_INTERFACE_URL_PATTERN, protocol, transportProperties.host(),
